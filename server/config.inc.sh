...
export PACKAGE_SOURCE_URL=http://www.kitmi.com.au/downloads/
...
export MYSQL_PASSWORD=mush2014tato
export MYSQL_MEM=512M #64M,128M,512M,2G,4G
...
export PHP_WITH_EACCELERATOR=1
...
export PHP_WITH_ZBARCODE=0
export PHP54_EXT_BUILD_NUM=20100525
export PHP53_EXT_BUILD_NUM=20090626

#define phpmyadmin configuration
export PHPMYADMIN_DIR_NAME=mushroom
...
export PHP53_TAR_NAME=php-5.3.28 #2014-03-06
export PHPMYADMIN_TAR_NAME=phpMyAdmin-3.5.2-english
export EACCELERATOR_TAR_NAME=eaccelerator-eaccelerator-42067ac #2014-03-06
...
export MONGODB_TAR_NAME=mongodb-linux-x86_64-2.4.9 #2014-03-13
